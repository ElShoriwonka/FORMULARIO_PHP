...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 21-06-2023 a las 22:51:46
...
INSERT INTO `tbl_comuna` (`id_comuna`, `nombre`, `idProvincia`) VALUES
(1, 'Iquique', 3),
(2, 'Alto Hospicio', 3),
(3, 'Pozo Almonte', 4),
(4, 'Camiña', 4),
...
ALTER TABLE `tbl_comuna`
  ...
  ADD KEY `COMUNA_PROVINCIA_ID` (`idProvincia`);
...
ALTER TABLE `tbl_provincia`
  ADD PRIMARY KEY (`id`),
  ADD KEY `PROVINCIA_REGION_ID` (`idRegion`);
